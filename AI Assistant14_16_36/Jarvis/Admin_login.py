...
class Login_Window:
    ...
    def login(self):
        if self.txtuser.get()=="" or self.txtpass.get()=="":
            ...
            messagebox.showinfo("Success","Welcome to KPA channel please subscribe my channel")
        else:
            ...
            if row==None:
                ...
                if open_main>0:
                    ...
                    self.app=User_Management(self.new_window)
                else:
                    if not open_main:
                        return
            conn.commit()
    ...
    def forgot_password_window(self):
        if self.txtuser.get()=="":
            ...
            if row==None:
                ...
                self.combo_securiy_Q["values"]=("Select","Your Birth Place","Your Nickname","Your Pet Name")
...
class Register:
    def __init__(self,root):
        ...
        self.combo_securiy_Q["values"]=("Select","Your Birth Place","Your Nickname name","Your Pet Name")
    ...
    def register_data(self):
        if self.var_fname.get()=="" or self.var_email.get()=="" or self.var_securityQ.get()=="Select":
            ...
            conn=mysql.connector.connect(host='localhost',user='root',password='1234',port='3306',database="mydata")
            my_cursor=conn.cursor()
            query=("select * from register where email=%s")
